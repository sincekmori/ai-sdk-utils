...
- 7edae13: chore(catalog): refresh the embedded models.dev cost snapshot

## 0.12.2

### Patch Changes

- f8c9629: chore(catalog): refresh the embedded models.dev cost snapshot
...
- f53cdea: feat(catalog)!: rename every exported Zod schema constant to `<Name>Schema` so it no longer shares its name with the inferred type
...
- 7fb8de7: chore(catalog): refresh the embedded models.dev cost snapshot

## 0.11.2

### Patch Changes

- 4062db2: chore(catalog): refresh the embedded models.dev cost snapshot

## 0.11.1

### Patch Changes

- 04210da: chore(catalog): refresh the embedded models.dev cost snapshot
